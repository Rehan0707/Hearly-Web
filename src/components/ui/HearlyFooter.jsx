    ...
    <footer className="w-full px-6 pt-12 pb-8 md:px-12 md:pt-24 md:pb-16 relative z-10" style={{ background: 'var(--bg-secondary)', borderTop: '1px solid var(--border-subtle)' }}>
      ...
      <div className="flex flex-col md:flex-row justify-between w-full max-w-[1400px] mx-auto mb-12 md:mb-16 gap-16">
        ...
        <div className="flex gap-16 md:gap-24 font-medium mr-4 md:mr-12">
          <div className="flex flex-col gap-4 text-[0.95rem] text-[#707070]">
            <a href="#" className="hover:text-[#AB1509] transition-colors">Add to Chrome</a>
            <a href="#" className="hover:text-[#AB1509] transition-colors">Product</a>
            <a href="#" className="hover:text-[#AB1509] transition-colors">Docs</a>
            <a href="#" className="hover:text-[#AB1509] transition-colors">Changelog</a>
            <a href="#" className="hover:text-[#AB1509] transition-colors">Press</a>
            <a href="#" className="hover:text-[#AB1509] transition-colors">Releases</a>
          </div>
          <div className="flex flex-col gap-4 text-[0.95rem] text-[#707070]">
            <a href="#" className="hover:text-[#AB1509] transition-colors">Blog</a>
            <a href="#" className="hover:text-[#AB1509] transition-colors">Pricing</a>
            <a href="#" className="hover:text-[#AB1509] transition-colors">Use Cases</a>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center text-sm text-[#707070] max-w-[1400px] mx-auto w-full">
        ...
        <div className="flex flex-wrap justify-center md:justify-end gap-6 md:gap-8 font-medium">
          <a href="#" className="hover:text-white transition-colors">About Hearly</a>
